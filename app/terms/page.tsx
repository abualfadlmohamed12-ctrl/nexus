          ...
          <div className="glass-card p-8 max-w-2xl w-full">
            ...
            <div className="space-y-6 text-sm text-muted-foreground leading-relaxed">
              <section>
                ...
                <p>By using Nexus, you agree to these Terms of Service. If you do not agree, please do not use our platform.</p>
              </section>
              <section>
                <h2 className="text-base font-semibold text-foreground mb-2">Use of Service</h2>
                <p>You may use Nexus for lawful purposes only. You are responsible for all content and applications you create using our platform.</p>
              </section>
              <section>
                <h2 className="text-base font-semibold text-foreground mb-2">Intellectual Property</h2>
                <p>You retain ownership of all code and applications you generate using Nexus. We retain ownership of the Nexus platform itself.</p>
              </section>
              <section>
                <h2 className="text-base font-semibold text-foreground mb-2">Limitations</h2>
                <p>Nexus is provided "as is" without warranties. We are not liable for any damages arising from your use of the platform.</p>
              </section>
              <section>
                <h2 className="text-base font-semibold text-foreground mb-2">Contact</h2>
                <p>For legal questions, contact us at <a href="mailto:legal@nexus.ai" className="underline hover:text-foreground transition-colors">legal@nexus.ai</a>.</p>
              </section>
            </div>
          </div>
        </main>
